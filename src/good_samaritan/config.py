...
class Limits(BaseModel): max_agent_steps:int=100; paid_model_max_agent_steps:int=40; recoverable_tool_retries:int=3; max_modified_files:int=12; max_diff_lines:int=1000; command_timeout_seconds:int=600; test_retries:int=3; daily_model_calls:int=100; daily_pr_limit:int=5; max_issue_assessments_per_run:int=5; provider_cooldown_seconds:int=60; provider_min_interval_seconds:int=65
