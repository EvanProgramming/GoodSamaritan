...
class Limits(BaseModel): max_agent_steps:int=100; paid_model_max_agent_steps:int=40; recoverable_tool_retries:int=3; max_model_wait_retries:int=3; max_exploration_steps:int=16; max_edit_actions:int=4; model_call_reserve:int=20; minimum_assessment_confidence:float=.75; max_provider_wait_seconds:int=65; max_modified_files:int=12; max_diff_lines:int=1000; command_timeout_seconds:int=600; test_retries:int=3; daily_model_calls:int=100; daily_pr_limit:int=5; max_issue_assessments_per_run:int=5; provider_cooldown_seconds:int=60; provider_min_interval_seconds:int=65; provider_retry_rounds:int=2; provider_retry_delay_seconds:int=5
...
class Models(BaseModel): priority:list[str]=Field(default_factory=lambda:["omniroute","groq","gemini","openrouter"]); groq_model:str=""; gemini_model:str=""; openrouter_model:str=""; deepseek_model:str=""; omniroute_model:str=""; omniroute_fallback_model:str="oc/nemotron-3-ultra-free"; omniroute_base_url:str="http://localhost:20128/v1"
