...
class Limits(BaseModel): max_agent_steps:int=40; max_modified_files:int=12; max_diff_lines:int=1000; command_timeout_seconds:int=600; test_retries:int=3; daily_model_calls:int=100; daily_pr_limit:int=5; max_issue_assessments_per_run:int=5; provider_cooldown_seconds:int=60; provider_min_interval_seconds:int=65
...
class Models(BaseModel): priority:list[str]=Field(default_factory=lambda:["groq","gemini","openrouter"]); groq_model:str=""; gemini_model:str=""; openrouter_model:str=""; deepseek_model:str=""; omniroute_model:str=""; omniroute_base_url:str="http://localhost:20128/v1"
...
def load_settings(path: Path | None = None, **overrides: object) -> Settings:
    ...
    env_map={
        ...
        "GROQ_MODEL":("models","groq_model",str), "GEMINI_MODEL":("models","gemini_model",str), "OPENROUTER_MODEL":("models","openrouter_model",str), "DEEPSEEK_MODEL":("models","deepseek_model",str), "OMNIROUTE_MODEL":("models","omniroute_model",str), "OMNIROUTE_BASE_URL":("models","omniroute_base_url",str),
    }
