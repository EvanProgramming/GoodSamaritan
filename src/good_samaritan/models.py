...
class Status(StrEnum):
    DISCOVERED="DISCOVERED"; SKIPPED="SKIPPED"; SELECTED="SELECTED"; CLONING="CLONING"; ANALYZING="ANALYZING"; EDITING="EDITING"; TESTING="TESTING"; REVIEWING="REVIEWING"; READY="READY"; SUBMITTING="SUBMITTING"; PR_CREATED="PR_CREATED"; FAILED="FAILED"
