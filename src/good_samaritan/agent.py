    ...
    def run(self,issue_text:str)->str:
        ...
        for _ in range(self.tools.limits.max_agent_steps):
            ...
            try:
                ...
                elif action.tool=="apply_patch": self.tools.apply_patch(action.path or '',action.old or '',action.new or '');out="patched"
